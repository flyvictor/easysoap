(function () {
    ...
    function _checkParams(params) {
        ...
        if (params.port === void 0 && params.host.match('https://')) params.port = 443;
        if (params.port === void 0) params.port = 80;
    ...
    var EasySoap = function(params, opts) {
        ...
        EasySoap.prototype.call = function(params, opts) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                // console.log("easysoap call", params, opts);

                // console.log("easysoap call", params.params["tns:segment"], opts);
                request.soapCall(params, opts)
                    .done(function(response) {

                        // console.log("Easy soap Response received", response);
